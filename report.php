<head>
    <title>Online Assessment Test</title>
    ...
    <div class="login">
       ...
       /*     include 'connect.php';
            ...
            else
            {
                ...
                echo '<div class="panel-heading">'.ucwords($fetch->name).'&nbsp;&nbsp;&nbsp;&nbsp;'.$fetch->roll.'&nbsp;&nbsp;&nbsp;&nbsp;'.$fetch->branch.'&nbsp;&nbsp;&nbsp;&nbsp;'.$fetch->Company_Name.'&nbsp;&nbsp;&nbsp;&nbsp;'.$fetch->Paper_Type.'</div>';
                ...
                echo '<tr style="color: green">'
                        ...
                        echo '<tr style="color: green">'
                        . '<td></td>'
                        . '<td>Technical Score (Total Correct)</td>'
                        . '<td>'.$t.'</td>'
                        . '<td>'.($t*5).'%</td>'
                        . '</tr>';
                echo '<tr>'
