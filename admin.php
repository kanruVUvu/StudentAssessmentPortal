...
<html>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="navbar-header">
            <a class="navbar-brand"><img src="10 Sec Logo.png" style="width: 20%;"></a>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <p class="navbar-brand" style="position:relative;top:-20px">Admin Login Page</p>
                </li>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="margin-left: 4em;">
                                    <input type="submit" id="login_button" name="sub" class="btn btn-m btn-primary" value="Login" onclick="checkLogin()" style="position:relative;bottom:-55px;left:-188px">
                            </div>  
                            </td>
